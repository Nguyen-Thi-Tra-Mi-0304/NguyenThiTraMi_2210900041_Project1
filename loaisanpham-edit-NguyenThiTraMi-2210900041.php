...
<head>
    ...
    <title>Trang Quản lý loại sản phẩm - Sửa loại sản phẩm</title>
...
<?php
        ...
        $edit_lsp_nttm = $lsp_nttm->edit_lsp_nttm($lsp_id_nttm);
        if($edit_lsp_nttm){
            $result_edit_lsp_nttm = $edit_lsp_nttm->fetch_array();
        }

        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            $DANHMUC_ID = $_POST["DANHMUC_ID"];
            $LSP_NAME = $_POST["LSP_NAME"];
            $update_lsp_nttm = $lsp_nttm -> update_lsp_nttm($DANHMUC_ID,$LSP_NAME,$lsp_id_nttm);
        }
    ?>
            ...
            <div class="content-right-cartegory-add">
                ...
                <form action="" method="post">
                    <select name="DANHMUC_ID">
                        ...
                        ?>
                        <option <?php if($result_edit_lsp_nttm["DANHMUC_ID"]==$result_nttm["DANHMUC_ID"]){echo "SELECTED";} ?>
                        value="<?php echo $result_nttm["DANHMUC_ID"]; ?>">
                    ...
                    value="<?php echo  $result_edit_lsp_nttm["LSP_NAME"] ?>">
